...
$plugin->version   = 2017120300;       // The current plugin version (Date: YYYYMMDDXX).
$plugin->requires  = 2016120506.01;    // Requires this Moodle version.
$plugin->cron      = 0;
$plugin->component = 'filter_rtmp';    // Full name of the plugin (used for diagnostics).
$plugin->maturity  = MATURITY_STABLE;
$plugin->release   = '1.11 (Build: 2017120300)';
